...
(function() {
  $(document).on('click', '#btn_shrink', function() {
    var input;
    input = '#shrink_url';
  ...
  $(document).on('click', '#btn_copyURL', function() {
    ...
    status.fadeIn('fast', function() {
      ...
      return status.fadeTo("fast", 0.9);
    });
    status.fadeIn('slow', function() {
      return status.css('display', 'block');
    });
    setTimeout((function() {
  ...
  $(document).on('click', '#btn_reshrink', function() {
    var input;
    input = '#shrink_url';
    $(input).attr('data-default', $(input).width());
    $(input).animate({
  ...
  $(document).on('submit', 'form#form-add-url', function(e) {
    var values;
    e.preventDefault();
    e.stopImmediatePropagation();
